...
class VehicleCategoryController extends Controller
{
    ...
    {
        try {
            $data = $this->vehicleCategoryService->getVehicleCategories();
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function show($vehicleCategory)
    {
        try {
            $data = $this->vehicleCategoryService->getVehicleCategory($vehicleCategory);
            $status = Response::HTTP_OK;
            $message = 'Success!';
        }
        catch (\Exception $e)
